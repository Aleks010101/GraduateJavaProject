...
import libary.pages.CDDPage;
import libary.pages.HomePage;
import libary.pages.LoginPage;
import libary.pages.SearchResultPage;
...
public class Login {
	...
	/*
	 * @Test(dependsOnMethods = "testLoginWrongPassword_negative") public void
	 * testLoginWrongUsername_negative() {
	 * 
	 ...
	 * System.out.println(message);
	 * 
	 * assert message.contains("Invalid login, please try again") :
	 * "You are logged in."; System.out.println("test passed");
	 * 
	 * }
	 * 
	 * @Test public void testLoginWrongPassword_negative() {
	 * 
